...
**Transaction Support for MuSig2 Aggregation and Verification in Tondi Tapscript**  
...
- Via OP_SUCCESSx for soft fork:  
  - OP_MUSIGKEYAGG: Aggregates public keys with coefficients.  
  - OP_MUSIGNONCEAGG: Aggregates nonces with binding.  
  - OP_MUSIGPARTIALSIG: Computes partial signature (off-chain hint, on-chain verify).  
  - OP_MUSIGVERIFY: Verifies aggregated signature.  
  Specific values in deployment table.  
