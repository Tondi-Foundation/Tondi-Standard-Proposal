...
|--:|---|---|---|  
|1|`p`|tstr|Protocol tag `"fun-20"`. Optional if header `"FN20"` is present. If present and value ≠ "fun-20", MUST be rejected as `bad-encoding` (Invalid).|  
