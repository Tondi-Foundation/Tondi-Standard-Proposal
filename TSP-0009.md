...
```
OpCheckTemplateVerify  (OP_SUCCESSx - 0xB6)
```
...
* **Implementation Note:** Tondi uses native `OP_SUCCESSx` (0xB6) mechanism defined in TSP-0001, providing soft-fork safety while maintaining Bitcoin BIP compatibility.  
