# TSP-0010: Tondi PTLC (Point Time-Locked Contract) Contract Specification (Full Draft)
**Status:** Draft (Soliciting Feedback)  
**Category:** Standards Track — Protocol/Consensus and Wallet  
**Target Network:** Tondi (Taproot-only; compatible with BIP-340/341/342 semantics)  
**Created:** 2025-09-05  
**Discussion Tags:** PTLC, Adaptor Signature, Taproot, MuSig2, DLC, Cross-Chain Atomic Swaps  
