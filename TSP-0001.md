---
title: TSP-0001 Taproot
description: This proposal defines the Tondi chain as a blockchain network that inherits full backward compatibility with all Kaspa payment types while introducing native Taproot (P2TR) support with Bitcoin Taproot OP_SUCCESS compatibility.
---
...
9. **Implementation Status**
   ...
   * **Bitcoin Taproot OP_SUCCESS Compatibility**:
     - ✅ **OpSuccess (0x50)**: Converted from OpReserved - Fully implemented
     - ✅ **OpSuccess1 (0x89)**: Converted from OpReserved1 - Fully implemented
     - ✅ **OpSuccess2 (0x8a)**: Converted from OpReserved2 - Fully implemented
     - 🔄 **Additional OP_SUCCESS Ranges**: 0x62, 0x7e-0x81, 0x83-0x86, 0x8d-0x8e, 0x95-0x99, 0xbb-0xfe - Reserved for future implementation
     - ✅ **Behavior Update**: Opcodes now return Ok(()) instead of BAD_OPCODE - Fully implemented
     - ✅ **Backward Compatibility**: RESERVED aliases maintained - Fully implemented
     - ✅ **WASM Bindings**: Updated for new opcode names - Fully implemented
     - ✅ **Test Data**: Updated to expect OK results - Fully implemented
   ...
   * **Soft Fork Ranges**: 
     - ✅ **Bitcoin Taproot OP_SUCCESS**: 0x50, 0x89, 0x8a - Fully implemented
     - 🔄 **General Soft Fork Opcodes**: 0xB2-0xBF (14 opcodes) - Reserved for future Tondi-specific features
     - 📋 **Allocated Opcodes**:
