# TSP-0012 — Channel Factories for Scalable Off-Chain Payment Networks in Tondi
...
- **New OPs** (Implemented via OP_SUCCESSx encoding for soft fork):  
  ...
  - (Optional) OP_CHECKSIGADD_FACTORY for incremental aggregation in multi-round setups.  
    Specific OP_SUCCESSx values will be fixed in the deployment parameters table (e.g., OP_SUCCESS207 for CTV_FACTORY).  
...
pub const OP_CHECKTEMPLATEVERIFY_FACTORY: u8 = 0xD7; // Using OP_SUCCESSx encoding
