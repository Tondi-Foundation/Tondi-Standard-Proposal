...
- **New OPs** (Implemented via OP_SUCCESSx encoding for soft fork):  
  - OP_CHECKSIG_CISA (0xB3)
  - OP_CHECKSIGVERIFY_CISA (0xB4)
  - (Optional) OP_CHECKSIGADD_CISA (0xB5)
...
pub const OP_CHECKSIG_CISA: u8 = 0xB3;
pub const OP_CHECKSIGVERIFY_CISA: u8 = 0xB4;
pub const OP_CHECKSIGADD_CISA: u8 = 0xB5;
