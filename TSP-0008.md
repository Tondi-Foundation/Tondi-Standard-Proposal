...
- **New OPs** (Implemented via OP_SUCCESSx encoding for soft fork):  
  - OP_CHECKSIG_CISA (0xce)
  - OP_CHECKSIGVERIFY_CISA (0xcf)
  - (Optional) OP_CHECKSIGADD_CISA (0xd0)
...
pub const OP_CHECKSIG_CISA: u8 = 0xce;
pub const OP_CHECKSIGVERIFY_CISA: u8 = 0xcf;
pub const OP_CHECKSIGADD_CISA: u8 = 0xd0;
